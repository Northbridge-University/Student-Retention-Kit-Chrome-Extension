...
export const MESSAGE_TYPES = {
    ...
    SRK_PING: 'SRK_PING',
    SRK_PONG: 'SRK_PONG',
    SRK_GET_MANIFEST_XML: 'SRK_GET_MANIFEST_XML',
    ...
    SRK_NAVIGATE_TO_STUDENT: 'SRK_NAVIGATE_TO_STUDENT',
...
export const DEFAULT_SETTINGS = {
    ...
    [STORAGE_KEYS.EXPORT_TAB_COLOR]: '#fcd5b4',
    ...
    [STORAGE_KEYS.NEXT_ASSIGNMENT_ENABLED]: true,
...
export const MASTER_LIST_COLUMNS = [
    ...
    { header: 'Course Start', field: 'courseStartDate', width: 12 },
    { header: 'Course End', field: 'courseEndDate', width: 12 },
